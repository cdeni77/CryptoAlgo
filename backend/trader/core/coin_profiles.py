...
COIN_PROFILES: Dict[str, CoinProfile] = {
    ...
    'BTC': CoinProfile(
        ...
        min_momentum_magnitude=0.017,    # Allow smaller moves to trigger
        vol_mult_tp=4.0,               # Push for larger winners
        vol_mult_sl=3.0,               # Tighter risk control
        max_hold_hours=72,
        cooldown_hours=12.0,
        min_vol_24h=0.002,             # BTC has lower vol than alts
        max_vol_24h=0.09,
    ...
    'SOL': CoinProfile(
        ...
        cooldown_hours=12.0,
        min_vol_24h=0.004,             # SOL has higher base vol
        max_vol_24h=0.12,
        position_size=0.12,
    ...
    'DOGE': CoinProfile(
        ...
        cooldown_hours=12.0,
        min_vol_24h=0.0035,              # DOGE always volatile
