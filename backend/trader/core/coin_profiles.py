...
COIN_PROFILES: Dict[str, CoinProfile] = {
    ...
    'XRP': CoinProfile(
        ...
        min_directional_agreement=0.54,
    ...
    'BTC': CoinProfile(
        ...
        signal_threshold=0.56,          # Lower bar so calibrated probabilities can trigger
        min_val_auc=0.50,
        label_forward_hours=36,         # Longer horizon for BTC trend persistence
        label_vol_target=1.8,           # Standard barriers
        min_momentum_magnitude=0.011,    # Allow smaller moves to trigger
        vol_mult_tp=4.0,               # Push for larger winners
        vol_mult_sl=3.0,               # Tighter risk control
        max_hold_hours=72,
        min_directional_agreement=0.53,
        meta_probability_threshold=0.49,
        cooldown_hours=10.0,
        min_vol_24h=0.001,             # BTC has lower vol than alts
        max_vol_24h=0.09,
    ...
    'SOL': CoinProfile(
        ...
        min_momentum_magnitude=0.012,
        min_directional_agreement=0.49,
        meta_probability_threshold=0.48,
        ...
        cooldown_hours=6.0,
        min_vol_24h=0.002,             # SOL has higher base vol
        max_vol_24h=0.12,
        position_size=0.12,
    ...
    'DOGE': CoinProfile(
        ...
        cooldown_hours=4.0,
        min_vol_24h=0.0015,              # DOGE always volatile
