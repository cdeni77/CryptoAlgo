...
from controllers.trade import (
    ...
    get_trades_by_coin, get_trade_stats
)
...
@router.get("/stats")
def trade_stats(db: Session = Depends(get_db)) -> Dict[str, Any]:
    """Aggregate trade performance stats: win rate, PNL, per-coin breakdown."""
    return get_trade_stats(db)
